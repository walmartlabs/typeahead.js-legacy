describe('Highlighter', function() {
  ...
  function init() {
    var highlighter = new Highlighter({pattern: this.pattern});
    return highlighter;
  }
  ...
  it('should support el to be native node object', function() {
    ...
    var highlighter = new Highlighter({el: this.$el[0], pattern: this.pattern});
  ...
  it('should throw error if pattern is not set', function() {
    function init() {
      var highlighter =new Highlighter({el: this.$el});
    }
    expect(init).toThrow();
  });
